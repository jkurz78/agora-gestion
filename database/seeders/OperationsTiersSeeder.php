...
class OperationsTiersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $operations = [
            ['nom' => 'Parcours 1', 'nombre_seances' => 30, 'statut' => 'en_cours', 'type_operation_id' => $typePsa?->id, 'date_debut' => '2025-09-15', 'date_fin' => '2026-06-30'],
            ['nom' => 'Parcours 2', 'nombre_seances' => 12, 'statut' => 'en_cours', 'type_operation_id' => $typeForm?->id, 'date_debut' => '2026-01-10', 'date_fin' => '2026-04-30'],
        ];
