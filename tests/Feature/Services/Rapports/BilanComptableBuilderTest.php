...
it('reclasse les soldes tiers atypiques selon leur sens débiteur ou créditeur', function (): void {
    $fournisseurDebiteur = creerCompteBilan('401', 'Fournisseurs débiteurs');
    $clientCrediteur = creerCompteBilan('411', 'Clients créditeurs');

    enregistrerLigneBilan($this, $fournisseurDebiteur, '2025-10-01', 6000, 0);
