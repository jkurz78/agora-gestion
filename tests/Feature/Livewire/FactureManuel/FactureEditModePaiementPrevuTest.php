...
// ── Test 1 : Facture sans MontantManuel → champ mode_paiement_prevu absent du DOM ──

it('le champ mode_paiement_prevu est absent du DOM si aucune ligne MontantManuel', function (): void {
...
// ── Test 2 : Facture avec ≥ 1 MontantManuel → champ mode_paiement_prevu présent ──

it('le champ mode_paiement_prevu est présent dans le DOM si au moins une ligne MontantManuel', function (): void {
    FactureLigne::create([
        'facture_id' => $this->facture->id,
