...
it('télécharge le template dépense', function () {
    ...
    $response = $this->actingAs($user)
        ->get(route('comptabilite.transactions.import.template', ['type' => 'depense']));
...
it('télécharge le template recette', function () {
    ...
    $response = $this->actingAs($user)
        ->get(route('comptabilite.transactions.import.template', ['type' => 'recette']));
...
it('redirige les invités vers login', function () {
    $response = $this->get(route('comptabilite.transactions.import.template', ['type' => 'depense']));
