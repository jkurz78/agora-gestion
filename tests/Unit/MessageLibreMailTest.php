...
function makeMessageLibreMail(array $overrides = []): MessageLibreMail
{
    ...
    return new MessageLibreMail(
        ...
        emailParticipant: $params['emailParticipant'],
        operationNom: $params['operationNom'],
        typeOperationNom: $params['typeOperationNom'],
        libelleArticle: $params['libelleArticle'],
        ...
        titreProchainSeance: $params['titreProchainSeance'],
        titrePrecedenteSeance: $params['titrePrecedenteSeance'],
        joursAvantProchaineSeance: $params['joursAvantProchaineSeance'],
        nbSeancesEffectuees: $params['nbSeancesEffectuees'],
        nbSeancesRestantes: $params['nbSeancesRestantes'],
        objet: $params['objet'],
        corps: $params['corps'],
