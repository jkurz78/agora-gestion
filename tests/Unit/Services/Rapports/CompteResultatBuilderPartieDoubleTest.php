...
it('[PD1] compteDeResultat — produit classe 7 agrégé par compte en mode PD', function () {
    ...
    creerRecettePD($tenantId, $this->user->id, (int) $this->compte706->id, 300.0, '2025-11-01');
    creerRecettePD($tenantId, $this->user->id, (int) $this->compte706->id, 200.0, '2025-12-01');
    ...
    expect($cat['famille_nom'])->toBe('70 — 70');
    ...
    $sc = $cat['comptes'][0];
    // La clé 'compte_id' peut contenir compte_id en mode PD (mapping transparent)
...
it('[PD2] compteDeResultat — charge classe 6 agrégée par compte en mode PD', function () {
    ...
    creerDepensePD($tenantId, $this->user->id, (int) $this->compte606->id, 150.0, '2025-10-01');
