...
<form wire:submit="saveStep7">
    <div class="form-check mb-3">
        ...
        <label class="form-check-label" for="planDefault">
            ...
            <br><small class="text-muted">~9 catégories, ~26 sous-catégories correspondant aux comptes comptables usuels (achats, charges de fonctionnement, services extérieurs, ventes, subventions, cotisations, dons…). Recommandé.</small>
        </label>
    </div>
    <div class="form-check mb-3">
