<div>
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('compta.banques.rapprochement.pdf', $rapprochement) }}" class="btn btn-outline-primary btn-sm">
                <i class="bi bi-download"></i> Télécharger PDF
            </a>
            <a href="{{ route('compta.banques.rapprochement.pdf', $rapprochement) }}?mode=inline" target="_blank" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-file-pdf"></i> Ouvrir PDF
            </a>
            <a href="{{ route('compta.banques.rapprochement.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    @if ($rapprochement->isEnCours() && ! $exerciceCloture && $this->canEdit)
        <div class="d-flex gap-2 mb-4">
            <a href="{{ route('compta.banques.rapprochement.index') }}" class="btn btn-outline-secondary">
