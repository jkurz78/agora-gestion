<div class="alert alert-info" role="alert">
    <h5 class="alert-heading">Démonstration en ligne</h5>
    <p class="mb-2">Connectez-vous avec un des comptes ci-dessous. Les données sont réinitialisées chaque nuit à 4h.</p>
