@php
$qualificatif = $typeOperation->formulaire_qualificatif_atelier ?? 'thérapeutique';
        ...
        <div class="card-body">
            ...
            <div class="form-check mb-3">
                ...
                <label class="form-check-label" for="droit_confidentiel">
                    Je donne mon accord pour la prise de photos/vidéos me concernant <strong>et pour un usage confidentiel au sein de l'équipe {{ $qualificatif }}</strong>
                </label>
            </div>
            <div class="form-check mb-3">
