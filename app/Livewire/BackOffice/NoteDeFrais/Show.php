...
final class Show extends Component
{
    ...
    public function constaterAbandon(): void
    {
        ...
        $this->validate([
            ...
            'dateDon.required' => 'La date du don est obligatoire.',
            'dateDon.date' => 'La date du don est invalide.',
        ]);
        ...
        try {
            ...
            session()->flash('success', 'La note de frais a été validée et l\'abandon de créance constaté.');
            $this->redirect(route('comptabilite.ndf.show', $this->ndf), navigate: false);
