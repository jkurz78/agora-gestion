...
enum CategorieEmail: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::Communication => 'Communication tiers',
        };
    }
    ...
    public function variables(): array
    {
        ...
        return match ($this) {
            ...
            self::Attestation => $common + [
                ...
                '{civilite}' => 'Civilité (Monsieur / Madame / vide)',
                '{adresse_polie}' => 'Adresse polie (Madame Kurz, Monsieur Dupont, ou Prénom Nom)',
                '{salutation}' => 'Salutation (Madame / Monsieur / "Madame, Monsieur")',
            ],
            self::Document => [
